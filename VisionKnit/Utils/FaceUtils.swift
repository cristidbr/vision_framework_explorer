...
extension VNFaceObservation
{
    ...
    public func toCGPointsInArea( areaSize: CGSize ) -> [ CGPoint ]
    {
        ...
        {
            points += region.pointsInImage( imageSize: areaSize ).map { CGPoint( x: $0.x, y: areaSize.height - $0.y ) }
        }
    ...
    {
        let contours = [ "faceContour", "leftEye", "rightEye", "leftEyebrow", "rightEyebrow", "nose", "outerLips", "innerLips", "leftPupil", "rightPupil" ];
